...
let virtual-env = "C:\Preethi\Programming\Python\workspace\pythonnumpy"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Preethi\Programming\Python\workspace\pythonnumpy\Scripts\deactivate.nu"
