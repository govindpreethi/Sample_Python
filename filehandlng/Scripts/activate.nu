...
let virtual-env = "C:\Preethi\Programming\Python\workspace\filehandlng"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Preethi\Programming\Python\workspace\filehandlng\Scripts\deactivate.nu"
